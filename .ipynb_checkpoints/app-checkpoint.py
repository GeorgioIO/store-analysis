...
data['Total Sale With Discount ($)'] = data['Sales'] * ( 1 - data['Discount'])
...
profitabiltiy_scores_per_order = data.groupby('Order ID')[['Sales' , 'Profit']].sum()
# TODO: Create Profitability score per order 
profitabiltiy_scores_per_order['Profitability Score (%)'] = round((profitabiltiy_scores_per_order['Profit'] / profitabiltiy_scores_per_order['Sales']) * 100 , 2)
top_ten_profitable_orders = profitabiltiy_scores_per_order.sort_values(by='Profit' , ascending=False).head(10)
least_ten_profitable_orders = profitabiltiy_scores_per_order.sort_values(by='Profit' , ascending=False).tail(10)
